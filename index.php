    ...
    <main>
        ...
        <section id="sobre">
            <div class = "container">
                ...
                <div class = "texto"> 
            <h2>Sobre Nós</h2>
            <p>Somos uma fazenda referenciada na criação e recria de gado de corte, utilizando práticas sustentáveis e manejo de alta qualidade.</p>
            <div\>
        <div\>
    </section>
        <section id="serviços">
        ...
        <selection id="estrutura">
            <div class="container">
                <img scr="Images/Esctrutura.jpg" alt="Estrutura da fazenda">
            <div class="texto">
        ...
        <div class="container">
             <img scr="Images/Contato01.png" alt="Informações para contato">
         <div class="texto">
            <h2>Contato</h2>
